...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=add,add_a_photo,arrow_back_ios,arrow_forward_ios,bolt,box,check,check_box_check_box_outline_blank,check_indeterminate_small,chevron_right,close,delete,delete_forever,download,edit,feedback,groups,indeterminate_check_box,info,lan,logout,notifications_off,refresh,remove,resume,rocket_launch,save,sentiment_very_satisfied,tune,visibility&display=block" />
