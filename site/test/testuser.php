...
<head>
    ...
    <script type="module" src="../sitejs/test-scripts/test_user.js" type="text/javascript"></script>
...
<body>
    ...
    <p>do not doubt</p>
    <p>enter in random stuff here and press little buttons to test</p>
    ...
    <button id="fetch">Fetch Info</button><br>
